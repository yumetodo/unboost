...
#define UNBOOST_VERSION             25
#define UNBOOST_VERSION_STRING      "Unboost 25 by Katayama Hirofumi MZ"
...
// swapping
    ...
    namespace unboost {
        ...
        #ifndef UNBOOST_CXX11
            #if (__cplusplus < 201103L) && !defined(_MSC_VER) && !defined(__clang__)    // not C++11
